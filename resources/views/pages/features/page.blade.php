    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
            ...
            <div class="relative p-6 bg-surface rounded-2xl border border-surface-foreground/5 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-foreground mb-2">Dynamic Branding & Identity</h3>
                <p class="text-sm text-surface-foreground/60">Total visual control via Admin settings. Update App Name, Logo, and Favicon instantly. Automatic <code>.ico</code> conversion ensures professional browser support across all platforms.</p>
            </div>

            {{-- Feature 19: Smart Maintenance --}}
            <div class="relative p-6 bg-surface rounded-2xl border border-surface-foreground/5 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex items-center justify-center h-12 w-12 rounded-xl bg-primary text-white shadow-lg mb-4">
                    <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
