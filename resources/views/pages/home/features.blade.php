...
@section('description', 'Discover every feature in Laravel FeatureKit v2.0.0. Feature-Driven Architecture, React 19, 20+ hooks, 11 utilities, 7 Artisan commands, and more.')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <p class="max-w-2xl mx-auto text-lg text-surface-foreground/60">
                A deep look at every system that ships with FeatureKit v2.0.0.
            </p>
        </div>
