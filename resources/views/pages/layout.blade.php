...
<head>
    ...
    <title>@yield('title', \App\Features\SystemSettings\Models\Setting::get('app_name', config('app.name')))</title>
    ...
    <meta property="og:title" content="@yield('og_title', \App\Features\SystemSettings\Models\Setting::get('app_name', config('app.name')))">
    ...
    <meta name="twitter:title" content="@yield('og_title', \App\Features\SystemSettings\Models\Setting::get('app_name', config('app.name')))">
